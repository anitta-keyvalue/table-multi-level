...
const Pagination = ({ canPreviousPage, canNextPage, pageOptions, pageCount, pageIndex, gotoPage, nextPage, previousPage, pageSize, setPageSize, theme }) => {
    return (jsxRuntime.jsxs("div", { className: "pagination-container", children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("button", { onClick: () => gotoPage(0), disabled: !canPreviousPage, className: "pagination-button", style: {
                        ...
                        }, children: '<<' }), jsxRuntime.jsx("button", { onClick: () => previousPage(), disabled: !canPreviousPage, className: "pagination-button", style: {
                            backgroundColor: theme.pagination?.button?.background,
                            color: theme.pagination?.button?.textColor,
                            opacity: !canPreviousPage ? theme.pagination?.button?.disabledOpacity : '1',
                        }, children: '<' }), jsxRuntime.jsx("button", { onClick: () => nextPage(), disabled: !canNextPage, className: "pagination-button", style: {
                            backgroundColor: theme.pagination?.button?.background,
                            color: theme.pagination?.button?.textColor,
                            opacity: !canNextPage ? theme.pagination?.button?.disabledOpacity : '1',
                        }, children: '>' }), jsxRuntime.jsx("button", { onClick: () => gotoPage(pageCount - 1), disabled: !canNextPage, className: "pagination-button", style: {
                            backgroundColor: theme.pagination?.button?.background,
                            color: theme.pagination?.button?.textColor,
                            opacity: !canNextPage ? theme.pagination?.button?.disabledOpacity : '1',
                        }, children: '>>' })] }), jsxRuntime.jsxs("div", { children: [jsxRuntime.jsxs("span", { style: { color: theme.pagination?.info?.textColor }, children: ["Page", ' ', jsxRuntime.jsxs("strong", { children: [pageIndex + 1, " of ", pageOptions.length] })] }), jsxRuntime.jsx("select", { value: pageSize, onChange: e => {
...
const TableHeader = ({ headerGroups, theme, sortable = false, ascendingIcon, descendingIcon, selectable = false, isAllSelected = false, onSelectAll, }) => {
    return (jsxRuntime.jsx("thead", { children: headerGroups.map((headerGroup) => {
            const { key: headerGroupKey, ...headerGroupProps } = headerGroup.getHeaderGroupProps();
            return (jsxRuntime.jsx("tr", { ...headerGroupProps, children: headerGroup.headers.map((column, index) => {
                    ...
                    return (jsxRuntime.jsx("th", { style: {
...
const TableCell = ({ cell, hasChildren, isExpanded, onToggle, paddingLeft = 0, theme, expandIcon, selectable = false, isRowSelected = false, onRowSelect, rowId, }) => {
    ...
    return (jsxRuntime.jsx("td", { ...cellProps, className: "table-cell", style: {
    ...
    if (!("getRowProps" in row)) {
        ...
        return (jsxRuntime.jsx("tr", { className: getRowClassName, style: getRowStyle, children: columns.map((column, index) => {
                ...
                return (jsxRuntime.jsx("td", { className: `table-cell ${level > 0 ? "table-cell-nested" : ""}`, style: {
                        color: theme.table?.cell?.textColor,
                        borderColor: theme.table?.cell?.borderColor,
                    }, children: jsxRuntime.jsxs("div", { className: "table-cell-content", children: [index === 0 && selectable && (jsxRuntime.jsx("input", { type: "checkbox", checked: isRowSelected, onChange: () => onRowSelect?.(dataItem.id), style: { marginRight: 8, cursor: 'pointer' } })), hasChildren && index === 0 ? (jsxRuntime.jsx("button", { onClick: handleExpandClick, className: "expand-button", children: expandIcon || (jsxRuntime.jsx(ExpandIcon, { isExpanded: isExpanded, theme: theme })) })) : (jsxRuntime.jsx("div", { className: "expand-button" })), column.render
...
const MultiLevelTable = ({ data, columns, pageSize = 10, theme, renderCustomPagination = null, sortable = false, ascendingIcon, descendingIcon, expandIcon, selectable = false, onSelectionChange, }) => {
    ...
    const parentRowIds = require$$0.useMemo(() => data.map(item => item.id), [data]);
    ...
    const tableColumns = require$$0.useMemo(() => {
        return columns.map((col) => ({
            ...
            Cell: ({ row, value, }) => {
                ...
                return (jsxRuntime.jsx("div", { children: col.render ? col.render(value, item) : value?.toString() }));
            },
    ...
    const rowsMap = require$$0.useMemo(() => {
        const map = new Map();
    ...
    const renderNestedRows = (parentId, level = 1) => {
        ...
        return children.map((child) => {
            ...
            return (jsxRuntime.jsxs(require$$0.Fragment, { children: [jsxRuntime.jsx(TableRow, { row: child, columns: columns, hasChildren: hasChildren, isExpanded: expandedRows.has(child.id), onToggle: () => hasChildren && toggleRow(child.id), level: level, theme: mergedTheme, expandIcon: expandIcon, selectable: false, isRowSelected: false }), renderNestedRows(child.id, level + 1)] }, child.id));
        });
    };
    const renderPagination = () => {
        ...
        return (jsxRuntime.jsx(Pagination, { canPreviousPage: canPreviousPage, canNextPage: canNextPage, pageOptions: pageOptions, pageCount: pageCount, pageIndex: pageIndex, gotoPage: gotoPage, nextPage: nextPage, previousPage: previousPage, pageSize: currentPageSize, setPageSize: setPageSize, theme: mergedTheme }));
    };
    const renderTableBody = () => {
        return (jsxRuntime.jsx("tbody", { ...getTableBodyProps(), children: page.map((row) => {
                prepareRow(row);
...
exports.MultiLevelTable = MultiLevelTable;
